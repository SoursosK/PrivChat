...
class Connection implements Runnable {
    ...
    //private PUCService puc;  na to sbhsw apo ola ta connections
    ...
    public Connection(ConnectionController connectionController, PUCService puc, Socket sock) {
    ...
    public void closeConnection() {
        try {
            ...
            this.ois.close();
            this.sock.close();
            this.connectionController.removeConnection(this);
            this.channel = null;
        } catch (IOException ex) {
            Logger.getLogger(Connection.class.getName()).log(Level.SEVERE, null, ex);
        }
